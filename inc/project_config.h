...
#define DFPLAYER_UART_RX_MUX (HAL_GPIO_36_UART2_RX_CM4)
#define DFPLAYER_UART_TX (HAL_GPIO_37)
#define DFPLAYER_UART_TX_MUX (HAL_GPIO_37_UART2_TX_CM4)
#define IO_EXP_I2C_CLK  (HAL_GPIO_27)
#define IO_EXP_I2C_CLK_MUX  (HAL_GPIO_27_I2C1_CLK)
#define IO_EXP_I2C_DATA (HAL_GPIO_28)
#define IO_EXP_I2C_DATA_MUX (HAL_GPIO_28_I2C1_DATA)
#define SEC_LED_PIN (HAL_GPIO_32)
#define SEC_LED_PIN_MUX (HAL_GPIO_32_GPIO32)
#define NIXIE_POWER_SWITCH_PIN (HAL_GPIO_29)
#define NIXIE_POWER_SWITCH_PIN_MUX (HAL_GPIO_29_GPIO29)
#define BACKLIGHT_LED_PIN (HAL_GPIO_31)
#define BACKLIGHT_LED_PIN_MUX (HAL_GPIO_31_GPIO31)
#define INDICATE_LED_PIN (HAL_GPIO_30)
#define INDICATE_LED_PIN_MUX (HAL_GPIO_30_GPIO30)
#define TOUCH_BTN_POWER_SWITCH_PIN (HAL_GPIO_0)
#define TOUCH_BTN_POWER_SWITCH_PIN_MUX (HAL_GPIO_0_GPIO0)
#define TOUCH_BTN_INPUT_PIN (HAL_GPIO_39)
#define TOUCH_BTN_INPUT_PIN_MUX (HAL_GPIO_39_GPIO39)
